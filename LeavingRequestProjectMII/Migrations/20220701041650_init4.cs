        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    divisi_id = table.Column<int>(type: "int", nullable: false),
                    isDeleted = table.Column<bool>(type: "bit", nullable: false),
                    tokenOtp = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    isActiveOtp = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    leavingMessage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    approvalMessage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    fileBukti = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    tipeFileBukti = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
